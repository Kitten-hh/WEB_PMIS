      ...
      >
        ...
        <fieldset class="col-12 taskSearch card-expansion-item expanded">
          <div
            ...
            :class="['collapse show row search_list mx-0', lang_code_en ? 'lang_en' : '']" name="search_list"
          >
            <div class="form-group col-sm-6 col-md-4 col-lg-3 col-xxxxl-2">
              <label class="col-form-label col-auto pl-0">{{$t("ADMRP_rp010")}}</label><!--跟進人 ADMRP_rp010-->
              <input
                type="text"
                v-model="currentPrompt.rp010"
                class="form-control col"
              />
            </div>
            ...
            <div class="form-group col-sm-12 col-md-8 col-lg query_condition">
              ...
              <!-- <input type="text" class="form-control col" v-model="currentPrompt.sname" /> -->
              <LPCombobox
            ...
            <div class="form-group d-flex col-12 col-sm systembug_category">
              <label class="col-form-label caption col-auto pl-0">{{
                $t("Category")
              }}</label>
              <LPCombobox
                ...
                showCount="20"
                width="500px"
                class="dropdownMenuScroll dropup"
              />
            </div>
            <div class="form-group col-auto">
              <div
...
data() {
  ...
  return {
    ...
    taskItemColumns:[ //問題跟進狀態列表信息 TaskItem
      { field: "itemid", label: this.$t("TaskItem_itemid"), width: "70px" }, //序號 TaskItem_itemid
      { field: "descriptions", label: this.$t("TaskItem_descriptions"), width: "300px" }, //處理內容 TaskItem_descriptions
      { field: "programmer", label: this.$t("TaskItem_programmer"), width: "70px" }, //跟進人 TaskItem_programmer
      { field: "startdate", label: this.$t("TaskItem_startdate"), width: "150px",
        render: function (data, type, row) {
      ...
      }, //開始日期 TaskItem_startdate
      { field: "enddate", label: this.$t("TaskItem_enddate"), width: "150px",
        render: function (data, type, row) {
          if (typeof data == "string") {
            data = data.slice(0, 10);
          }
      ...
      }, //結束日期 TaskItem_enddate
      { field: "progress", label: this.$t("TaskItem_progress"), width: "70px" }, //進度 TaskItem_progress
    ],
...
methods: {
  ...
  docmhClick(){
    ...
    /* 給對應字段賦值 */
    // rp022 和 rp001 可以取任意一條數據的 mh001 和 mh002
    ...
    this.currentMaster.rp027 = dataArray.map(item => item.mh003).join(";"); // 功能描述
  ...
  undoMaster(){
    ...
    this.state = 0;
    this.masterState = 0;
    if(String(this.currentMaster.rp016 || "") != ""){
      this.getImgArray();
