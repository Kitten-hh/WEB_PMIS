    ...
    $(function () {
        ...
        form1.on_init_format = function(data) {
            ...
            window.setTimeout(function () {
                getTechnicId()
                form1.redirect_url = "/PMIS/opportunity/Technical_Material?param="+$('#stepper_from_div input[name="mb023"]').val()+'&inc_id='+$('#stepper_from_div input[name="inc_id"]').val();
            }, 100);
        }
        ...
        form1.on_after_init = function (data) {
            ...
            form1.redirect_url = "/PMIS/opportunity/Technical_Material?param="+param+'&inc_id='+inc_id;
            //獲取對應的SolutionType
            $.ajax({
                type: "GET",
                ...
                success: function (result) {
                    if (result.state) {
                        ...
                        if(jsondata.length>0){
                            if ($('#stepper_from_div input[name="mb023"]').val().slice(0,8).trim()!=jsondata[0]['theTechnicid'].slice(0,8).trim()){
