    ...
    <div id="app" class="analysis_page page-inner">
        <div class="subheader dropdown">                 
            <div class="el-example task_search_tools">   
                <button class="btn btn-primary font-weight-bolder" @click="search('Bonus')"><i class="fa fa-search mr-2"></i>{{$t("Search Bonus")}}</button>
                <button :class="['btn btn-hover-text-primary font-weight-bolder', isMobile ? 'btn-light px-0' : 'btn-secondary']"
                    @click="bonusAnalysis('yesterday')">
                    <img class="d-block d-md-none" src="/static/BonusApp/images/newYDay.png">
                    <span class="d-none d-md-inline">{{ $t("Yesterday") }}</span>
                </button>
                <button :class="['btn btn-hover-text-primary font-weight-bolder', isMobile ? 'btn-light px-0' : 'btn-secondary']" @click="bonusAnalysis('today')">
                    <img class="d-block d-md-none" src="/static/BonusApp/images/newTDay.png">
                    <span class="d-none d-md-inline">{{ $t("Today") }}</span>
                </button>  
                <button :class="['btn btn-hover-text-primary font-weight-bolder', isMobile ? 'btn-light px-0' : 'btn-secondary']"
                    @click="bonusAnalysis('lastweek')">
                    <img class="d-block d-md-none" src="/static/BonusApp/images/newLW.png">
                    <span class="d-none d-md-inline">{{ $t("Last Week") }}</span>
                </button> 
                <button :class="['btn btn-hover-text-primary font-weight-bolder', isMobile ? 'btn-light px-0' : 'btn-secondary']"
                    @click="bonusAnalysis('week')">
                    <img class="d-block d-md-none" src="/static/BonusApp/images/newW.png">
                                    ...
                                    >
                                        <div class="card card-reflow mb-0">                                             
                                            <div class="form-inline task_search_tools mt-2 px-3">   
                                                ...
                                                <button id="btnNew" type="button" class="btn btn-sm btn-primary" @click="newDeductionItem">
                            ...
                            <table id="dt_summary" class="table table-borderless table-hover table-vertical-center mb-0 table-row-dashed">
                                <thead>
                                    ...
                                    <tr class="text-center th_details">
                                        ...
                                        <th class="min-w-110px w-90px-c text-dark-75">{{$t("Simulate Total Take In $Per Mth")}}</th>
  ...
  data() {
    ...
    return {        
        taskColumns: [
            ...
            {
                field: "edate", label: this.$t("E Date"), width:"70px",
                className: 'desktop',
